# CSGO-Intermediate-Guide
A guide that picks up where the [newbie guide](https://github.com/swiprCS/CSGO-Newbie-Guide) leaves off.
...
**Movement** (While we can go over what Surfing, Bhopping, and KZ is able to do for your mechanics, not many guides will bring up the importance of what else is involved, such as of information shown in [this image](http://clutchround.com/wp-content/uploads/2015/08/csgo_corners_and_angles_dust2_T_CT.png), and [this video](https://www.youtube.com/watch?v=a8YRkgwE_rk). It would be great to try and cover the different facets in hopes that people become aware of such factors sooner)

* Make sure to be aware that there's more to movement than the typical "kz, bhop, and surfing", since peeking even has its own methods (wide/shoulder/jiggle peeks) that involve counterstrafing, which is essential to understand when elevating your game. Remember it takes a lot of time to grasp and master, so have patience and it'll pay off in the end!
...
If you're having difficulties pinpointing bad habits you may have developed, or you'd like some feedback about your gameplay, the r/csgocritic subreddit may be useful. There, you can submit one of your matches to be analyzed by other community members. TheOnlyBarker has done analyses there many times, so feel free to send him a PM if you want a match to be looked at. If these do not provide much help, voo CS:GO has made a video on [how to analyze your own demos](https://www.youtube.com/watch?v=kJUfagFvxL0).

* Sometimes you will learn best by sitting back and watching those that are more experienced than you, which can be done by watching professional matches/some selective streamers ([n0thing](https://www.twitch.tv/n0thing), [autimatic](https://www.twitch.tv/autimatictv)], [flusha](https://www.twitch.tv/flusha), etc, those who do not go exclusively for flashy plays). Although it may be complex to understand their decisionmaking, focusing on one thing at a time, and trying to incorporate it into your play may prove to be benficial. For example, a rudimentary skill is crosshair placement, which can be seen at nearly every second of play.

* Will continue this bullet point later, but basically what Steel goes over in [this video](https://www.youtube.com/watch?v=Q3RGvu88tTw) (how just because a play worked, doesn't mean that it's always the right play, due to situational reasons)
